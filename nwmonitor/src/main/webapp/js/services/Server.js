...
var Server = (function() {
	...
	/*
	 * Method returns data for server summary tab
	 */
	ServerService.prototype.getServerSummaryData = function(serverId)
	{			
		return this.DataSource.getServerSummary(serverId);
	};
